<template>
  <view class="message-other-cell" :class="{ 'host-managed-unimp-app': hostManagedUnimpApp }">
    <image
      class="avator-img"
      mode="aspectFill"
...
.message-other-cell.host-managed-unimp-app {
  .avator-img {
    width: 34px;
    height: 34px;
  }
  .message-other-cell-bg .message-other-cell-time {
    font-size: 12px;
    margin-left: 15px;
  }
  .message-other-cell-content {
