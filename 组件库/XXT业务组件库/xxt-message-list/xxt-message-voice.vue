<template>
  <view
    ...
    :class="{ 'is-not-t-self': !isSelf, 'host-managed-unimp-app': hostManagedUnimpApp }"
...
// 宿主管理 App 语音条按新视觉收窄字号，其他 App 保持 master 原展示尺寸。
...
.message-self-cell-voice-file.host-managed-unimp-app {
  margin-right: 15px;
  padding: 0 12px;
  height: 44px;
}
